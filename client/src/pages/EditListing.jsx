    ...
    <div>
      <div className="p-3 max-w-4xl mx-auto">
        ...
        <form
          ...
          className="flex flex-col sm:flex-row flex-1 gap-6"
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="uppercase p-3 bg-slate-700 rounded-lg text-white hover:opacity-95 disabled:opacity-80"
            >
